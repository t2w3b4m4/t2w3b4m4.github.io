...
function About() {
  ...
  return (
    <div className="about">
      ...
      <div>
        圖(tú)文(wén)並(bìng)茂(mào) is an idiom in Chinese, and it means the text and visual contents are complementing each other well and both are excellent. I see my collection of works as 圖文並茂, hence the title.
      </div>
      <h3>What to expect?</h3>
      <div>
        We will be exploring materialism, symbolism, story, and more. Materialism, in the context of this book, and in a greater scope of philosophy to me, is the idea that all physical objects/matters are intrinsically rational, and their manifestation of emotions were created by the subjectivity of emotional beings, i.e. us humans.
      </div>
      <div>
        <br />
        Have fun.
